...
const bulletList1 = [
  ...
  { avatar: cm_img_4, nickName: '未来冲冲冲', time: '2023.10.13', desc: '我很喜欢这款小助手的界面设计，简洁明了，一目了然。每次面试前都会用它来准备，效果真的超好👍！' },
  { avatar: cm_img_5, nickName: '未来冲冲冲', time: '2023.11.5', desc: '我用这款小助手准备面试，真的是事半功倍！它的模拟面试功能让我提前熟悉了面试环节，让我心里有底了。' },
  { avatar: cm_img_6, nickName: '未来冲冲冲', time: '2023.8.18', desc: '我用过很多面试工具，但是这款小助手无疑是我最爱的一个❤️。它的功能强大，操作简单，真的很赞！' },
];
